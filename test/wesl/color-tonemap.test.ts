...
test("tonemapACES3", async () => {
  ...
  expectCloseTo([0.9149, 0.8768, 0.8038], result, 0.001);
});
...
test("tonemapACES4", async () => {
  ...
  expectCloseTo([0.9149, 0.8768, 0.8038, 0.8], result, 0.001);
});
...
test("tonemapFilmic3", async () => {
  ...
  expectCloseTo([0.9128, 0.8874, 0.8412], result, 0.001);
});
...
test("tonemapLinear3", async () => {
  ...
  expectCloseTo([2.0, 1.5, 1.0], result, 0.001);
});
...
test("tonemapReinhard3", async () => {
  ...
  expectCloseTo([0.7782, 0.5836, 0.3891], result, 0.001);
});
...
test("tonemapReinhardJodie3", async () => {
  ...
  expectCloseTo([0.7038, 0.5935, 0.4445], result, 0.001);
});
...
test("tonemapUnreal3", async () => {
  ...
  // R: 2.0 / (2.0 + 0.155) * 1.019 = 2.0 / 2.155 * 1.019 ≈ 0.9464
  // G: 1.5 / (1.5 + 0.155) * 1.019 = 1.5 / 1.655 * 1.019 ≈ 0.9234
  // B: 1.0 / (1.0 + 0.155) * 1.019 = 1.0 / 1.155 * 1.019 ≈ 0.8823
  expectCloseTo([0.9464, 0.9234, 0.8823], result, 0.001);
});
...
test("tonemapFilmic4", async () => {
  ...
  expectCloseTo([0.9128, 0.8874, 0.8412, 0.8], result, 0.001);
});
...
test("tonemapLinear4", async () => {
  ...
  expectCloseTo([2.0, 1.5, 1.0, 0.5], result, 0.001);
});
...
test("tonemapReinhard4", async () => {
  ...
  expectCloseTo([0.7782, 0.5836, 0.3891, 0.6], result, 0.001);
});
...
test("tonemapReinhardJodie4", async () => {
  ...
  expectCloseTo([0.7038, 0.5935, 0.4445, 0.75], result, 0.001);
});
...
test("uncharted2Tonemap", async () => {
  ...
  expectCloseTo([0.3574, 0.2963, 0.2207], result, 0.001);
});
...
test("tonemapUnreal4", async () => {
  ...
  // Same as tonemapUnreal3: [0.9464, 0.9234, 0.8823], alpha = 0.65
  expectCloseTo([0.9464, 0.9234, 0.8823, 0.65], result, 0.001);
});
